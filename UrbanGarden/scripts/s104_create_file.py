...
def get_metadata_type(attribute_name):
    ...
    :param attribute_name: The name of the attribute to retrieve the type for.
    ...
    typeMap['typeOfWaterLevelData'] = numpy.int64
...
def add_metadata(attributes, metadata_file):
    """ Add metadata values to the S-104 attributes.

    :param attributes: The S-104 attributes to be populated.
...
def create_command_line():
    ...
    parser = argparse.ArgumentParser(description='Create S-104 File')
