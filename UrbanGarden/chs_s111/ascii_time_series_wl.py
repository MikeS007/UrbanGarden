...
class AsciiTimeSeriesWL:
    ...
    def read_next_row(self):
        ...
        :returns: A tuple containing the date, waterlevel (m).
        """
        ...
        # 2017/01/01 00:00  31   0.541 
        
        # NEW CODE 
        #We expect the following: Date (YYYY/MM/DD), HourMinute (hhmm), WaterLevel (m)
        # 2017/01/01 00:00   2.610
        ...
        waterlevel = float(components[2])

        #Return a tuple with dateAndTime, waterlevel
        return (dateAndTime, waterlevel, speed)
